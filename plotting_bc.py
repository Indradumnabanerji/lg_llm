...
average_opinion = df.iloc[1:41][columns_to_average].mean()
average_factual = df.iloc[42:81][columns_to_average].mean()
average_imaginative = df.iloc[82:117][columns_to_average].mean()

# Create a DataFrame to hold these averages for easier plotting
averages_df = pd.DataFrame({
    'Opinion': average_opinion,
    'Factual': average_factual,
    'Imaginative': average_imaginative
})
