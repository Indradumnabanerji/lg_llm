...
class HallucinatedResponse:
    ...
    def get_mistral_response(self, prompt):
        ...
        return mistral(prompt, temperature=2.0, top_p=0.01)
    ...
    def get_gpt2_response(self, prompt):
        ...
        outputs = model.generate(inputs, max_length=500, num_return_sequences=1, temperature=2.0, top_p=0.01, do_sample=True)
    ...
    def get_cerebras_response(self, prompt):
        ...
        output = pipe(prompt, max_length=50, do_sample=True, temperature=2.0, top_p=0.01, no_repeat_ngram_size=2)
